...
file class Array
{
    internal const int IntrosortSizeThreshold = 4;
}
...
internal sealed partial class ArraySortHelper<T>
{
    ...
    public void Sort(Span<T> keys, IComparer<T>? comparer)
    {
        ...
        {
            throw new ArgumentException("Bad comparer.", nameof(comparer));
        }
        catch (Exception e)
        {
            throw new InvalidOperationException("IComparer failed.", e);
        }
    }
