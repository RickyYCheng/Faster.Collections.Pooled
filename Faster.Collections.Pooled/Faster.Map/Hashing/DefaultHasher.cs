...
namespace Faster.Collections.Pooled.Hashing;
...
public static class DefaultHasher
{
    ...
    public readonly struct Generic<T> : IHasher<T>
    {
        ...
        {
            // ATTENTION: 
            // For value types, use EqualityComparer<T>.Default which the JIT/AOT
            // can optimize better than calling x.Equals(y) directly.
            // This avoids potential boxing and virtual call overhead in AOT scenarios.
